...
import { fetchNetflixOriginals, selectAllNetflixOriginals, selectNetflixError } from '../../redux/slices/netflixOriginalsSlice'
import { fetchTopRated, selectAllTopRated, selectTopRatedError } from '../../redux/slices/topRatedSlice'
import { fetchTrending, selectAllTrending, selectTrendingError } from '../../redux/slices/trendingSlice'
...
export default function Home() {
  ...
  const { genres: movieGenres, status: movieStatus } = useSelector(selectMovies)
  const { genres: seriesGenres, status: seriesStatus } = useSelector(selectTvShow)
